...
import 'package:clinic_app/Controllers/agora_controller.dart';
import 'package:clinic_app/UI/home_page.dart';
import 'package:clinic_app/helpers/utils.dart';
    ...
    if (isSomeOneJoinedCall) {
      Future.delayed(Duration(milliseconds: 300), () {
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => VideoCallHomePage()));
      });
    } else {
      showDialog(
        context: context,
            ...
            FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => VideoCallHomePage()));
              },
            ),
            FlatButton(
              child: Text("No"),
